oc login https://api.starter-ca-central-1.openshift.com -u username

oc new-build redhat-openjdk18-openshift:latest~git@bitbucket.org:username/paas-demo.git --build-secret=ssh --source-secret=ssh
